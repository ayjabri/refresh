...
class DQNetConv(nn.Module):
    def __init__(self, shape, actions, device='cpu'):
        ...
        self.input = nn.Conv2d(in_channels=self.features, out_channels= 32, kernel_size=8,stride=4)
        self.conv1 = nn.Conv2d(in_channels=32, out_channels= 64, kernel_size=4, stride=2)
...
class DDQN(nn.Module):
    def __init__(self, shape, actions):
        ...
        self.conv1  = nn.Conv2d(in_channels=shape[0], out_channels=32, kernel_size=8, stride=4)

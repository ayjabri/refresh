...
class EpisodicRewardEnv(gym.Wrapper):
    def __init__(self, env=None, reward_limit=3):
        """Make new-reward == end-of-episode, but only reset on true game over.
        
        This helps long round games like tennis to shorten the episode.
        Ayman Jabri
        """
        super(EpisodicRewardEnv, self).__init__(env)
    ...
    def reset(self):
        ...
        This way all states are still reachable even though rewards are episodic,
